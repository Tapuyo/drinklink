  ...
  forgotpassword()async{
    ...
    if(response.body.isNotEmpty){
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => ResetPass(emailController.text)),
      );
    }
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Text('Code will be sent to your email.', style: TextStyle(wordSpacing: 3,color: Colors.white, fontSize: 16),)
              ),
