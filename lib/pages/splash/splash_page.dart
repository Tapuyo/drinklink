    ...
    return MaterialApp(
      ...
      home: Container(
        ...
        child: Column(
          ...
          children: [
            Text('DrinkLink', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 50,decoration: TextDecoration.none,),),
            Text('More good times.', style: TextStyle(color: Colors.deepOrange, fontSize: 16, fontFamily: 'NunitoSans' ,decoration: TextDecoration.none,),)
          ],
        )
      ),
    );
