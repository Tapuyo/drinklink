...
class MoreDetails extends StatefulWidget {
  ...
  @override
  _MoreDetailsState createState() => _MoreDetailsState(this.code,this.byw,this.outlet);
}
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(outlet, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14),),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('CODE:', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 30),),
                      SizedBox(width: 10,),
                      Text(code.substring(0,1), style: TextStyle(color: Colors.deepOrange, fontWeight: FontWeight.bold, fontSize: 50),),
                      Text(code.substring(1,), style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 50),),
                    ],
                  ),
                ),
                SizedBox(height: 20,),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Spacer(),
                      Text(mins.toString() + ':' + secs.toString(), style: TextStyle(color: Colors.deepOrange,fontSize: 40,fontWeight: FontWeight.bold),),
                      Text('min', style: TextStyle(color: Colors.deepOrange,fontSize: 30),),
                    ],
                  ),
                ),
                SizedBox(height: 10,),
                Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      Text('Prepared by:' + byw, style: TextStyle(color: Colors.white, fontSize: 16),),
                    ],
                  ),
                ),
                SizedBox(height: 20,),
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(snapshot.data[index].itemsname, style: TextStyle(color: Colors.deepOrange, fontSize: 25),),
                              SizedBox(width: 20,),
                              Text(snapshot.data[index].volume, style: TextStyle(color: Colors.white, fontSize: 18),),
                              Spacer(),
                              Text(snapshot.data[index].itemsquantity, style: TextStyle(color: Colors.white, fontSize: 25,fontWeight: FontWeight.bold),),
                            ],
                          )
  ...
  Future<List<MyItems>> getOrdersList() async{
    ...
    for (var i = 0; i < jsondata.length ; i++){
      ...
      for (var x in jsondata1){
        ...
        MyItems nt = new MyItems(x['drink']['name'],quat,x['drink']['volume']);
